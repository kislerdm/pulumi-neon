...
namespace PulumiSdk.Neon
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/kislerdm/pulumi-neon/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PulumiSdk.Neon.version.txt");
    ...
    internal sealed class NeonResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NeonResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
